    ...
    <div className="flex min-h-screen flex-col">
      ...
      <main className="flex-1">
        <div className="mx-auto max-w-5xl px-6 py-16">
          ...
          <p className="mt-1 text-foreground-dim">Tu biblioteca TAQTios Web AI</p>
          ...
          <div className="mt-8 grid gap-4 sm:grid-cols-3">
            <div className="rounded-xl border border-border bg-surface p-5">
              ...
              <p className="mt-1 text-sm text-foreground-dim">Templates disponibles</p>
            </div>
            <div className="rounded-xl border border-border bg-surface p-5">
              <p className="font-heading text-3xl font-extrabold">{featured.length}</p>
              <p className="mt-1 text-sm text-foreground-dim">Destacados</p>
            </div>
            <div className="rounded-xl border border-border bg-surface p-5">
              <p className="font-heading text-3xl font-extrabold">
                {hasAccess ? "Activo" : "—"}
              </p>
              <p className="mt-1 text-sm text-foreground-dim">Estado del acceso</p>
            </div>
          </div>
