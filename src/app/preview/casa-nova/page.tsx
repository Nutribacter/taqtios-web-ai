...
export default function CasaNovaPreview() {
  return (
    <div className="min-h-screen bg-[#F2E9DD] font-serif text-[#3A2E22] antialiased">
      ...
      <section className="relative mx-6 flex h-[65vh] items-end overflow-hidden rounded-2xl bg-[#B98559]">
        ...
        <div className="mt-10 space-y-8">
          {ROOMS.map((r) => (
            <div key={r.name} className="grid gap-4 sm:grid-cols-2">
              <div className="aspect-[4/3] rounded-xl bg-[#B98559]/60" />
      ...
      <section className="mx-auto max-w-2xl px-6 py-16 text-center font-sans">
      ...
      <section className="border-t border-[#3A2E22]/10 px-6 py-20 text-center font-sans">
        <p className="text-sm uppercase tracking-widest text-[#3A2E22]/50">Reservas</p>
        <button className="mt-6 rounded-sm bg-[#8A4A2A] px-8 py-3 text-sm font-semibold text-white">
