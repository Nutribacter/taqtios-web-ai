  ...
  return (
    <div className="min-h-screen bg-[#F4FAFB] font-sans text-[#1B2A2E] antialiased">
      ...
      <header className="mx-auto flex max-w-5xl items-center justify-between px-6 py-6">
        ...
        <button className="rounded-lg bg-[#1A8FA3] px-5 py-2 text-sm font-semibold text-white">
          Sacar turno
        </button>
      </header>
      ...
      <section className="mx-auto max-w-3xl px-6 pt-8 pb-16 text-center">
        ...
        <button className="mt-8 rounded-lg bg-[#1A8FA3] px-8 py-3 text-sm font-semibold text-white">
          Sacar turno
        </button>
      </section>

      <section className="border-t border-[#1B2A2E]/10 px-6 py-16">
      ...
      <section className="border-t border-[#1B2A2E]/10 px-6 py-12 text-center text-sm text-[#1B2A2E]/60">
